...
################################################################################
# CDP Master Startup Script - EXAMPLE CONFIGURATION
# 
# This is an example configuration file showing how to configure the master
# startup script for your specific environment.
#
# Copy this file to master-startup.sh and edit the configuration values.
################################################################################
